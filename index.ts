...
let isLoggedIn: boolean = false;  // Initialize with a default value
...
function addReviews(array: Review[]): void {
    if (reviewContainer && container && button && !count) {
        count++;
...
const mainImageContainer = document.querySelector('.main-image') as HTMLElement | null;
